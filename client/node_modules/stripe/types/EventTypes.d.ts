...
declare module 'stripe' {
  ...
  namespace Stripe {
    ...
    /**
     * Occurs when an Accountâ€™s `balance_refresh` status transitions from `pending` to either `succeeded` or `failed`.
     */
    ...
    /**
     * Occurs when an Accountâ€™s `ownership_refresh` status transitions from `pending` to either `succeeded` or `failed`.
     */
    ...
    /**
     * Occurs when an Accountâ€™s `transaction_refresh` status transitions from `pending` to either `succeeded` or `failed`.
     */
    ...
    /**
     * Occurs whenever a draft invoice cannot be finalized. See the invoiceâ€™s [last finalization error](https://docs.stripe.com/api/invoices/object#invoice_object-last_finalization_error) for details.
     */
