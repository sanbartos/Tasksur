...
export interface DayPickerBase {
   ...
   *
   * Use this prop when you need to change the default class names â€” for example
  ...
  /**
   * A unique id to replace the random generated id â€“ used by DayPicker for
   * accessibility.
   */
  id?: string;
  ...
  fixedWeeks?: boolean;
  /**
   * Hide the monthâ€™s head displaying the weekday names.
   *
   * @defaultValue false
   */
  hideHead?: boolean;
...
export interface CustomComponents {
  ...
  /** The component for the tableâ€™s head row. */
