...
export interface ConfirmationToken {
  ...
  /**
   * Indicates that you intend to make future payments with this ConfirmationTokenâ€™s payment method.
   *
   * The presence of this property will [attach the payment method](https://stripe.com/docs/payments/save-during-payment) to the PaymentIntentâ€™s Customer, if present, after the PaymentIntent is confirmed and any required actions from the user are complete.
   *
