...
export interface Stripe {
  ...
  /**
   * Use `stripe.confirmUsBankAccountPayment` in the [Accept a payment](https://stripe.com/docs/payments/ach-debit/accept-a-payment) flow for the [ACH Direct Debit]((https://stripe.com/docs/payments/ach-debit) payment method to record the customerâ€™s authorization for payment.
   *
   ...
   * payment method to collect the customerâ€™s bank account in your payment form.
   *
  ...
  /**
   * Use `stripe.confirmUsBankAccountSetup` in the [Save bank details](https://stripe.com/docs/payments/ach-debit/set-up-payment) flow for the [ACH Direct Debit payment](https://stripe.com/docs/payments/ach-debit) method to record the customerâ€™s authorization for future payments.
   *
  ...
  /**
   * Use `stripe.createToken` to create a single-use token that wraps a userâ€™s legal entity information.
...
export interface WrapperLibrary {
  /**
   * Your libraryâ€™s name, maximum length is 30
   */
  name: string;
