...
export interface PaymentRequest {
  ...
  /**
   * Shows the browserâ€™s payment interface.
  ...
  /**
   * Closes the browserâ€™s payment interface.
   */
  abort: () => void;

  /**
   * `true` if the browserâ€™s payment interface is showing.
   * When using the `PaymentRequestButtonElement`, this is called for you automatically.
   */
  isShowing: () => boolean;
  ...
  /**
   * Stripe.js automatically creates a `Token` after the customer is done interacting with the browserâ€™s payment interface.
  ...
  /**
   * Stripe.js automatically creates a `PaymentMethod` after the customer is done interacting with the browserâ€™s payment interface.
  ...
  /**
   * Stripe.js automatically creates a `Source` after the customer is done interacting with the browserâ€™s payment interface.
   ...
   * If youâ€™re using the cancel event as a hook for canceling the customerâ€™s order, make sure you also refund the payment that you just created.
   */
...
export interface PaymentRequestUpdateOptions {
  ...
  /**
   * This `PaymentRequestItem` is shown to the customer in the browserâ€™s payment interface.
   */
  total?: PaymentRequestItem;

  /**
   * An array of PaymentRequestItem objects.
   * These objects are shown as line items in the browserâ€™s payment interface.
...
export interface PaymentRequestShippingOption {
   ...
   * Youâ€™ll be told the ID of the selected option on changes and on completion.
   */
  id: string;
...
export type PaymentRequestCompleteStatus =
  ...
  /**
   * Report to the browser that you were unable to process the customerâ€˜s payment.
...
export interface PaymentRequestShippingAddress {
   ...
   * This might be a person, a business name, or contain â€œcare ofâ€ (c/o) instructions.
   */
  recipient?: string;
...
export interface PaymentRequestShippingAddressEvent {
   ...
   * The full shipping address appears in the `PaymentRequestEvent` object after the purchase is confirmed in the browserâ€™s payment interface
   */
  shippingAddress: PaymentRequestShippingAddress;
}
