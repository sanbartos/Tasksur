...
export interface StripeElementChangeEvent {
   ...
   *
   * It is not an indicator of whether a customer is done with their inputâ€”it only indicates that the Element contains a potentially complete, well-formed value.
