...
export interface RichSlotType<P> {
     ...
     * instance, setting this on a Button slot ensures that clicking on the Buttonâ€™s text will still select the Button and not
     ...
     *  the parent component for the user's convenience. Handy for various â€œwrapper" components, form fields, and so on.
     */
