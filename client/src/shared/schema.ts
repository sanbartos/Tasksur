...
// Define el tipo NotificationPreferences para las preferencias de notificaciones
...
// âœ… Tabla messages (corregida para permitir mensajes generales)
export const messages = pgTable("messages", {
  id: serial("id").primaryKey(),
  taskId: integer("task_id").references(() => tasks.id), // âœ… Eliminado .notNull() para permitir NULL
...
// âœ… Relaciones messages (actualizadas para manejar taskId opcional)
export const messagesRelations = relations(messages, ({ one }) => ({
  task: one(tasks, {
    fields: [messages.taskId],
    references: [tasks.id],
    // âœ… Relación opcional ya que taskId puede ser NULL
  }),
  sender: one(users, {
...
// âœ… InsertMessageSchema (actualizado para taskId opcional)
export const insertMessageSchema = createInsertSchema(messages, {
  taskId: z.number().optional(), // âœ… Ahora es opcional
}).omit({
  id: true,
  createdAt: true,
  isRead: true,
