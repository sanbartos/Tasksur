...
export function registerTaskRoutes(app) {
    ...
    app.post("/api/tasks", isAuthenticated, authorizeRoles("client"), validateBody(createTaskSchema), TaskController.createTask);
    app.patch("/api/tasks/:id", isAuthenticated, canModifyTask, validateBody(updateTaskSchema), TaskController.updateTask);
    app.delete("/api/tasks/:id", isAuthenticated, canModifyTask, TaskController.deleteTask);
}
