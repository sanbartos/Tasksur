...
export function registerNotificationRoutes(app) {
     ...
     */
    app.patch('/api/notifications/:id/read', isAuthenticated, validateIdParam, async (req, res, next) => {
        try {
            ...
            if (!notification)
                return res.status(404).json({ message: ERROR_MESSAGES.notificationNotFound });
